...
function NameTagFallback({ name, rarity }: { name: string; rarity: string }) {
  const bg = rarity === 'legendary' ? 'from-yellow-500 to-amber-600'
    ...
    : rarity === 'rare' ? 'from-[#B7FF18] to-[#6FA800]'
          ...
          <div className="hide-scrollbar flex flex-col">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-secondary/30 rounded-full flex items-center gap-2 pr-4 pl-1 py-1">
                  {ownerAvatarUrl ? (
                    ...
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#B7FF18] to-[#A2F000] border-2 border-border" />
                  )}
                ...
                <div className="bg-secondary/30 border border-border rounded-full flex items-center gap-2 px-3 py-1.5">
                  ...
                  <span className="text-xs font-bold text-[#B8C0AE]">1.2k active</span>
                </div>
              </div>
            ...
            <div className="px-6 pt-4 pb-6 flex flex-col gap-4 items-center">
              {nameTag.owned ? (
                ...
                <Button
                  className="w-full h-[68px] rounded-2xl text-[#0A0A10] text-lg font-black uppercase bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] cursor-default"
                  disabled
                  style={{ letterSpacing: '-0.9px' }}
                >
