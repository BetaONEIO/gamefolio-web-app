                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-card border border-border rounded-[24px] p-6 flex items-center gap-5">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <h3 className="text-2xl font-black text-[#F5F7F2] uppercase tracking-[-0.6px] leading-tight mb-1">{badge.name}</h3>
                      <div className="flex items-center gap-1.5">
                        <ShieldCheck className="w-3.5 h-3.5 text-[#B8C0AE]" />
                        <span className="text-[12px] font-bold text-[#B8C0AE]">Legendary Asset</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-card border border-border rounded-[24px] overflow-hidden">
                    <div className="flex justify-between items-center p-4 border-b border-border">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <div className="bg-[#B7FF181a] rounded px-1.5 py-0.5">
                          <span className="text-[10px] font-bold text-[#B7FF18] uppercase">GF</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex justify-between items-center p-4 border-b border-border">
                    ...
                    <div className="flex justify-between items-center p-5">
                      <span className="text-[16px] font-bold text-[#F5F7F2] uppercase tracking-[1.4px]">Total Cost</span>
                      <div className="flex items-baseline gap-1">
                        <span className="text-2xl font-black text-[#B7FF18] tracking-[-0.5px] uppercase">{totalCost}</span>
                        <span className="text-2xl font-black text-[#B7FF18] tracking-[-0.5px] uppercase ml-1">GF</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-secondary/20 border border-border rounded-[16px] p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#B7FF181a] flex items-center justify-center p-2.5">
                        <img src={gfTokenLogo} alt="G" className="w-full h-full" />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] font-black text-[#B8C0AE] uppercase">Your Balance</span>
