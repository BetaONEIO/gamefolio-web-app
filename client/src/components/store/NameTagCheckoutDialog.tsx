              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#0B1218] border border-[#f0b10033] rounded-[24px] p-4 flex items-center gap-4 shadow-[0_10px_15px_-3px_rgba(255,105,0,0.05)]">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl font-black text-[#F5F7F2] uppercase tracking-[-1.2px] leading-tight mb-1">{nameTag.name}</h3>
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-bold text-[#B8C0AE] uppercase tracking-[0.5px]">Type</span>
                      <span className="text-[12px] font-bold text-[#F5F7F2]">Name Tag</span>
                    </div>
                  </div>
                </div>
              </div>
