        ...
        <AnimatePresence mode="wait">
          {showCheckout ? (
            ...
            >
              ...
              <div className="flex flex-col md:hidden h-[90vh] max-h-[900px] overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
                {leftPanel}
              ...
              <div className="hidden md:flex md:flex-row h-[600px]">
                <div className="w-1/2 h-full overflow-hidden">
                  {leftPanel}
                </div>
                <div className="w-px bg-[#1e293b] flex-shrink-0" />
                <div className="w-1/2 h-full overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
                  {rightPanel}
                </div>
              </div>
            </motion.div>
