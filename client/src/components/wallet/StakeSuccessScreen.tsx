      ...
      <div className="scrollbar-hide flex-1 overflow-y-auto flex flex-col items-center gap-10 px-6 pt-10 pb-6 max-w-[430px] md:max-w-[600px] lg:max-w-[800px] mx-auto w-full">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#B7FF18" }} />
              <span
                className="text-[10px] font-bold uppercase"
                style={{ color: "#B7FF18", letterSpacing: "0.25px" }}
              >
                Confirmed
              </span>
            </div>
        ...
        {/* Action Buttons */}
        <div className="flex flex-col gap-3 w-full pb-28">
          <button
            onClick={onDone}
            ...
            style={{
              background: "#B7FF18",
              color: "#0A0A10",
              boxShadow: "0 10px 15px -3px rgba(183, 255, 26, 0.2), 0 4px 6px -4px rgba(183, 255, 26, 0.2)",
            }}
          >
