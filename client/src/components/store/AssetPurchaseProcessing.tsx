    ...
    <div className="flex flex-col items-center justify-center flex-1 w-full bg-[#0B1218] text-white p-6 animate-in fade-in duration-500">
      <div className="flex flex-col items-center gap-12 max-w-[382px] w-full">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <h2 className="text-[30px] font-black uppercase tracking-[-1.5px] leading-[36px] text-[#F5F7F2]">
            {step === 1 ? "Finalizing..." : "Minting..."}
          </h2>
          <p className="text-sm font-medium uppercase tracking-[-0.35px] leading-[22.75px] text-[#B8C0AE]">
        ...
        <div className="w-full flex flex-col p-1 bg-[#0B121880] backdrop-blur-[4px] border border-[#1B2A334d] rounded-[24px]">
          ...
          <div className="flex items-center gap-4 p-4">
            ...
            <div className="flex flex-col">
              <span className={`text-xs font-black uppercase tracking-[1.2px] transition-colors duration-500 ${step >= 1 ? 'text-[#F5F7F2]' : 'text-white/20'}`}>
                Payment Confirmed
              </span>
              <span className={`text-[10px] font-bold transition-colors duration-500 ${step >= 1 ? 'text-[#B8C0AE]' : 'text-white/10'}`}>
                Transaction broadcasted
              </span>
            </div>
          </div>

          <div className="mx-4 border-t border-[#1B2A3380]" />
        ...
        {/* Footer Warning */}
        <div className="w-full flex items-center justify-center gap-2 p-3 bg-[#1B2A334d] border border-[#1B2A3380] rounded-2xl">
          <ShieldAlert className="w-4 h-4 text-[#B8C0AE]" />
          <span className="text-[11px] font-black uppercase tracking-[1.1px] text-[#B8C0AE]">
