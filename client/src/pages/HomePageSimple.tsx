        ...
        <section className="px-4 sm:px-6 md:px-8">
          <Link href="/surprise-me" className="group flex items-center justify-between gap-4 overflow-hidden rounded-2xl border border-[#B7FF1A]/30 bg-gradient-to-r from-[#13231b] via-[#0d1919] to-[#101522] p-4 shadow-[0_0_30px_rgba(183,255,26,0.07)] transition-all hover:border-[#B7FF1A]/60 hover:shadow-[0_0_35px_rgba(183,255,26,0.13)]">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div><div className="flex items-center gap-2"><h2 className="font-black text-white sm:text-lg">Surprise Me</h2><span className="flex items-center gap-1 rounded-full bg-[#B7FF1A]/15 px-2 py-0.5 text-[11px] font-black text-[#B7FF1A]"><Sparkles className="h-3 w-3" />2x XP</span></div><p className="mt-0.5 text-xs text-white/55 sm:text-sm">Discover a random clip or reel · 5 bonuses daily</p></div>
            </div>
