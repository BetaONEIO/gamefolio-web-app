...
**How to apply:** Reuse the existing upload-limit endpoint for the copy, keep native upload and campaign association as separate server steps, and preserve replacement-submission metadata when the upload is reviewed again.