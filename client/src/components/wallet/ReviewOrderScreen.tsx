        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-bold" style={{ color: '#B7FF18' }}>Free</span>
            </div>
        ...
        <div className="max-w-[600px] mx-auto w-full flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs font-bold" style={{ color: '#B7FF18' }}>Includes all taxes</span>
            </div>
          ...
          >
            <span style={{ color: '#0A0A10' }}>Proceed to Payment</span>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
