...
export const CustomAvatar = ({ 
  ...
  if (hasNftProfile) {
    return (
      ...
      >
        <div
          className="w-full h-full rounded-lg overflow-hidden border-2 border-[#4ade80]/40 shadow-[0_0_12px_rgba(74,222,128,0.15)]"
        >
          <img
        ...
        <div className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-[#4ade80] rounded-sm flex items-center justify-center shadow-sm">
