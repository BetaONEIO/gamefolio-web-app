      ...
      >
        ...
        <div className="flex items-center justify-between w-full max-w-[430px] md:max-w-[600px] lg:max-w-[800px] mx-auto">
          ...
          <button
            ...
            style={{ background: "#1B2A33", border: "1px solid #1B2A33" }}
          >
            <Filter className="w-5 h-5" style={{ color: "#B7FF18" }} />
          </button>
        </div>
        ...
        <p
          ...
          style={{ color: "#B8C0AE", lineHeight: "20px" }}
        >
      ...
      <div className="flex items-center gap-2 px-6 py-6 overflow-x-auto scrollbar-hide max-w-[430px] md:max-w-[600px] lg:max-w-[800px] mx-auto w-full">
        {filters.map((filter) => (
          <button
            ...
            style={{
              background: activeFilter === filter.key ? "#B7FF18" : "#1B2A33",
              border: `1px solid ${activeFilter === filter.key ? "#B7FF18" : "#1B2A33"}`,
              color: activeFilter === filter.key ? "#0A0A10" : "#B8C0AE",
            }}
          >
            {filter.label}
          </button>
        ...
        {hasTransactions ? (
            ...
            {filteredTransactions.map((tx) => (
              ...
              >
                ...
                >
                  ...
                  {tx.type === "received" && (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M12 19L12 5M12 19L6 13M12 19L18 13" stroke="#B7FF18" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  )}
                  {tx.type === "staking" && (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M12 2L12 22M12 2L6 8M12 2L18 8M12 22L6 16M12 22L18 16" stroke="#B8C0AE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  )}
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold truncate" style={{ color: "#F5F7F2" }}>
                    {tx.title}
                  </p>
                  <p className="text-xs truncate" style={{ color: "#B8C0AE" }}>
                    {tx.subtitle}
                  </p>
                </div>
                <div className="flex flex-col items-end">
                  <span
                    ...
                    style={{ color: tx.amount > 0 ? "#B7FF18" : "#F5F7F2" }}
                  >
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col items-center gap-3 text-center max-w-[350px]">
              <h2 className="text-2xl font-bold" style={{ color: "#F5F7F2" }}>
                No Activity Yet
              </h2>
              <p className="text-sm leading-relaxed" style={{ color: "#B8C0AE" }}>
            ...
            <div className="flex flex-col gap-3 w-full max-w-[350px]">
              ...
              >
                <Sparkles className="w-5 h-5" style={{ color: "#B7FF18" }} />
