...
export function getCardTheme(user: TrendingEntry['user']): { style: React.CSSProperties; isLight: boolean; hasCustomBg: boolean } {
  ...
  // Named themes — same conditions as ProfilePage
  ...
  // Profile background image takes top priority
  ...
  // Named theme gradients / solid backgrounds
  ...
  // Custom gradient CSS set by the user
