  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <p className="text-white/60 mb-1">Staked Amount</p>
          <p className="text-white">
            {staked} {symbol}
          </p>
        </div>
        <div>
          <p className="text-white/60 mb-1">Rewards Earned</p>
      ...
      <div className="mt-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-white/60">Staking Period</span>
          <span className="text-white">42 days left</span>
        </div>
