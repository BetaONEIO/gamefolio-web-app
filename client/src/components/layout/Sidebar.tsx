              ...
              <Link key={item.href} href={item.href} onClick={() => { closeClipDialog(); if (item.href === '/' && location === '/') setLocation('/'); }}>
                ...
                >
                  {'gamefolioIcon' in item && item.gamefolioIcon ? (
                    <span className="w-6 h-6 flex-shrink-0 inline-flex items-center justify-center -translate-x-1 transition-all duration-300 group-hover:[filter:drop-shadow(0_0_10px_rgba(183,255,26,0.45))] overflow-visible">
