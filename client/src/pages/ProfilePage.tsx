      ...
      {isNeoTheme && (
        <style>{`
          ...
          .neo-canvas {
            position: fixed; inset: 0; pointer-events: none; z-index: 0;
            opacity: 0.18;
            animation: neoFlicker 28s step-start infinite;
          }
          .neo-vignette {
            position: fixed; inset: 0; pointer-events: none; z-index: 0;
          ...
          .neo-scanline {
            ...
            animation: neoScanline 20s linear infinite;
          }
          .neo-stats-card {
            animation: neoGlow 10s ease-in-out infinite;
          }
          .neo-tab-list {
          ...
          .neo-gradient-text {
            ...
            -webkit-text-fill-color: transparent;
            background-clip: text;
            animation: neoTextShift 14s linear infinite;
          }
