...
export default function MultiMintSuccessScreen({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#0A0A10] flex flex-col overflow-hidden font-['Plus_Jakarta_Sans',sans-serif]">
      <header className="sticky top-0 z-40 backdrop-blur-md bg-[#0A0A10cc] border-b border-[#1B2A3380] flex-shrink-0">
          ...
          <div className="flex flex-col md:flex-row md:gap-8 md:px-4 md:py-8">
                ...
                {displayNfts.map((_, i) => (
                  <button
                    ...
                    className={`flex-1 h-1.5 rounded-full transition-colors ${
                      i === activeIndex ? "bg-[#B7FF18]" : "bg-[#1B2A33]"
                    }`}
                  />
                ))}
              </div>
                  ...
                  {displayNfts.map((nft, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`relative w-full rounded-[40px] overflow-hidden bg-[#0A0A10] shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.05)] cursor-pointer ${
                            legendary
                              ? "border-2 border-[#fbbf24]/60 shadow-[0_0_30px_rgba(251,191,36,0.3)]"
                              : "border border-[#1B2A3380] hover:border-[#B7FF1840]"
                          } transition-all`}
                          onClick={() => {
                          ...
                          <div className="relative w-full aspect-square">
                            {nft.imageUrl ? (
                              ...
                              <div className="w-full h-full bg-[#1B2A33] flex items-center justify-center">
                                <div className="w-12 h-12 rounded-full border-2 border-[#B7FF18]/30 border-t-[#B7FF18] animate-spin" />
                              </div>
                            )}
                          ...
                          <div className="p-4 pb-5 flex flex-col gap-1">
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <span className={`text-sm font-normal font-['JetBrains_Mono',monospace] leading-5 flex-shrink-0 ${
                                legendary ? "text-[#fbbf24]" : "text-[#B7FF18]"
                              }`}>
            ...
            <div className="md:flex-[2] flex flex-col">
              ...
              <div className="flex flex-col gap-3 px-6 md:px-0 pb-4">
                <div className="w-full h-[74px] rounded-2xl bg-[#0A0A1080] border border-[#1B2A3380] flex items-center justify-between px-4">
                  ...
                  <button onClick={onViewCollection} className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                    <span className="text-sm font-bold text-[#B7FF18] leading-5">Explore All</span>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2.66699 8H13.3337M13.3337 8L9.33366 4M13.3337 8L9.33366 12" stroke="#B7FF18" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                </div>
                ...
                <button
                  ...
                  className="w-full h-14 rounded-2xl bg-[#B7FF18] flex items-center justify-center gap-[6.5px] shadow-[0_4px_6px_-4px_rgba(183, 255, 26,0.2),0_10px_15px_-3px_rgba(183, 255, 26,0.2)] hover:bg-[#A2F000] transition-colors"
                >
                  ...
                  <span className="text-base font-bold text-[#0A0A10] leading-6">Add to Collection</span>
                </button>
