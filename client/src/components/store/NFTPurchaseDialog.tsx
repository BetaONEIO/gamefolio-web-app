            ...
            <div className="hide-scrollbar flex flex-col gap-8 px-6 py-4 pb-7">
                ...
                <div className="bg-card border border-border rounded-2xl p-[17px] flex items-center gap-4 h-[130px]">
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex items-center gap-1.5 mb-0.5">
                      <span className="text-[10px] font-bold text-[#B7FF18] uppercase" style={{ letterSpacing: '0.5px' }}>
                        Cyber Guardians
                      </span>
                      <VerifiedBadge />
                    </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-card border border-border rounded-2xl overflow-hidden">
                  ...
                  <div className="flex items-center justify-between px-4 h-[53px] border-b border-border">
                    ...
                    <span className="text-sm font-bold text-[#B7FF18]">Free</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between px-4 h-[75px] bg-[#14532d]/10">
                    ...
                    <div className="flex flex-col items-end">
                      <span className="text-lg font-bold text-[#B7FF18] leading-7">{totalAmount.toFixed(2)} GFT</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-card border border-border rounded-2xl p-[17px] flex flex-col gap-4">
                  ...
                  {hasEnoughBalance ? (
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#B7FF18]/10 rounded-2xl h-8">
                      <CheckmarkCircle />
                      <span className="text-xs text-[#B7FF18]">Sufficient balance for this transaction</span>
                    </div>
                  ) : (
              ...
              <div className="flex flex-col gap-3 pt-4">
                  <Button
                    ...
                    className="w-full h-[60px] rounded-2xl bg-[#B7FF18] text-[#0A0A10] text-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div className="flex flex-col gap-6 px-6 py-6 flex-1">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-[#B7FF18]">Cyber Guardians</span>
                    <Check className="w-4 h-4 text-[#B7FF18]" />
                  </div>
                  <h1 className="text-3xl font-bold text-[#F5F7F2]" data-testid="text-nft-name">
                    {nft.name.replace(/^.*#/, 'Guardian #')}
                  </h1>
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#B7FF18] to-[#A2F000] border-2 border-border" />
                ...
                <div className="bg-card border border-border rounded-2xl p-5 flex flex-col gap-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <span className="text-sm font-bold text-[#B7FF18]">2h 45m 02s</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    <Button
                      ...
                      className="w-full h-[60px] rounded-2xl bg-[#B7FF18] text-[#0A0A10] text-lg font-bold hover:opacity-90 transition-all"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      >
                        ...
                        <span className="text-[10px] text-[#B7FF18]">{prop.percent}</span>
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1">
                          <span
                            className={`text-sm ${
                              detail.link ? "text-[#B7FF18]" : "text-[#F5F7F2]"
                            } ${detail.mono ? "font-mono" : ""}`}
                          >
                            {detail.value}
                          </span>
                          {detail.link && (
                            <ExternalLink className="w-3 h-3 text-[#B7FF18]" />
                          )}
                        </div>
                      </div>
                    ))}
