            ...
            <ul className="space-y-4">
              ...
              {user && (
                <li>
                  ...
                  >
                    <GamefolioIcon size={24} glow={true} className="flex-shrink-0 mr-1.5 transition-all duration-300 group-hover:[filter:drop-shadow(0_0_10px_rgba(183,255,26,0.5))]" />
