            ...
            <ul className="space-y-4">
              ...
              {user && (
                <li>
                  ...
                  >
                    <span className="mr-3 w-6 h-6 flex-shrink-0 inline-flex items-center justify-center translate-x-0.5 overflow-visible transition-all duration-300 group-hover:[filter:drop-shadow(0_0_10px_rgba(183,255,26,0.5))]">
