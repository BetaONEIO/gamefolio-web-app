            ...
            <div className="flex-none relative flex items-center justify-center overflow-hidden" style={{ height: 'clamp(300px, calc(100dvh - 340px), 500px)' }}>
              ...
              {selectedPath === 'indie' ? (
                <>
                  ...
                  <img src={imgHandPixel} alt="" aria-hidden draggable={false} className="select-none absolute z-20 hand-point" style={{ bottom: 'clamp(80px, 16%, 140px)', left: '50%', transform: 'translateX(-50%)', width: 'clamp(180px, 50%, 280px)', height: 'auto', filter: 'drop-shadow(0 4px 12px rgba(0,0,0,0.6))' }} />
