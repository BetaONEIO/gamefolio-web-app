  ...
  return (
    <SectionCard style={getLeagueMeshBackground(data.league)}>
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center gap-4 mb-6">
          <LeagueMedal tier={data.league} size={120} />
          <div>
          ...
          <>
            <div className="flex items-center justify-center gap-3 sm:gap-5 mb-3">
              <div className="flex flex-col items-center gap-2 w-28 flex-shrink-0">
                <LeagueMedal tier={data.league} size={144} />
              ...
              <div className="flex flex-col items-center gap-2 w-28 flex-shrink-0">
                <LeagueMedal tier={data.nextLeague ?? "Onyx"} size={144} />
                <span className="text-[11px] font-bold text-center leading-tight" style={{ color: TEXT_PRIMARY }}>
        ...
        {isOnyx && (
          <div className="space-y-3">
            <div className="flex items-center justify-center gap-3 sm:gap-5 mb-1">
              <div className="flex flex-col items-center gap-2 w-28 flex-shrink-0">
                <LeagueMedal tier="Onyx" size={144} />
                <span className="text-[11px] font-bold text-center leading-tight" style={{ color: TEXT_PRIMARY }}>
                  Onyx League
                </span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 w-28 flex-shrink-0">
                <LeagueMedal tier="Diamond" size={144} />
                <span className="text-[11px] font-bold text-center leading-tight" style={{ color: TEXT_PRIMARY }}>
                  Diamond League
                </span>
              </div>
        ...
        {isDiamond && (
          <div className="space-y-3">
            <div className="flex items-center justify-center gap-3 sm:gap-5 mb-1">
              ...
              <ArrowUpRight className="w-5 h-5 flex-shrink-0" style={{ color: TEXT_MUTED }} />
              <div className="flex flex-col items-center gap-2 w-28 flex-shrink-0">
                <LeagueMedal tier="Champion" size={144} />
                <span className="text-[11px] font-bold text-center leading-tight" style={{ color: TEXT_PRIMARY }}>
                  Champion League
                </span>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-center mb-1">
              <div className="flex flex-col items-center gap-2 w-32">
                <LeagueMedal tier="Champion" size={168} />
