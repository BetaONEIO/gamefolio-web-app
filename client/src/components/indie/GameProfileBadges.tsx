...
export function GamefolioPlatformButton({
  ...
  const sharedClassName = `group inline-flex items-center gap-2 rounded-full border border-[#2B3040] bg-[#0A0A10] px-4 py-2 text-xs font-bold tracking-[0.01em] text-white/85 transition-colors hover:border-[#B7FF18]/70 hover:bg-[#171A29] hover:text-white ${className}`;
