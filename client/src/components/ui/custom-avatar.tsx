...
export const CustomAvatar = ({ 
  ...
  if (hasNftProfile) {
    ...
    return (
      <>
      <div
        className={`${sizeClasses[size]} relative inline-flex items-center justify-center ${className} cursor-pointer`}
      ...
      >
        ...
        <div
          ...
          style={{ borderColor: borderColor, zIndex: 10 }}
        >
          <img
        ...
        <div className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: borderColor, zIndex: 20 }}>
