      ...
      <div className="flex-1 overflow-y-auto">
        <div className="w-full max-w-[430px] md:max-w-3xl mx-auto flex flex-col items-center px-6 pt-4 pb-[250px] md:pb-[200px]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 w-full py-6">
            <div className="w-[192px] h-[192px] md:w-[240px] md:h-[240px] rounded-3xl overflow-hidden bg-white/[0.01] shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.1)] flex-shrink-0">
              {nft.imageUrl ? (
                <img
                  src={nft.imageUrl}
                  alt={displayName}
