...
const slides = [
  ...
  },
  {
    ...
    icon: (
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M36 60L60 36" stroke="#B7FF1A" strokeWidth="4" strokeLinecap="round"/>
        <path d="M84.82 45.64L51.32 12.14C50.42 11.24 49.22 10.74 47.92 10.74H20C16.7 10.74 14 13.44 14 16.74V44.46C14 45.76 14.5 47.04 15.4 47.92L48.88 81.42C50.76 83.3 53.78 83.3 55.68 81.42L84.82 52.28C86.72 50.38 86.72 47.52 84.82 45.64Z" stroke="#B7FF1A" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.3"/>
        <circle cx="28" cy="28" r="6" fill="#B7FF1A"/>
      </svg>
    ),
  },
];
    ...
    return (
      <div className="flex flex-col w-full h-full min-h-[500px] md:min-h-[600px] bg-[#101D27] relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-8 px-6 relative z-10">
          ...
          >
            <div className="bg-[#B7FF1A1a] border border-[#B7FF1A4d] rounded-full px-4 py-1.5">
              <span className="text-[10px] font-black text-[#B7FF1A] uppercase tracking-[2px]">
                Subscription Active
              </span>
            </div>
          ...
          {lootboxReward ? (
            <motion.div
              ...
              className="flex flex-col items-center gap-3"
            >
              <div className="flex items-center gap-2 text-[#B7FF1A]">
            ...
            >
              <div className="absolute inset-0 rounded-full bg-[#B7FF1A4d] blur-[30px]" />
