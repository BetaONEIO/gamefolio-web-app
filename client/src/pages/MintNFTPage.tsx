        ...
        <div className="w-full max-w-md md:max-w-4xl flex flex-col md:flex-row md:items-center md:gap-16 items-center">
          <div className="md:flex-1 flex flex-col items-center">
            <div className="relative mb-8 md:mb-0">
              <div className="absolute inset-0 blur-[32px] bg-[#B7FF18]/20 rounded-full scale-150" />
              ...
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2">
                <div className="bg-card border border-border rounded-full px-4 py-2 shadow-lg flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#B7FF18] animate-pulse" />
                  <span className="text-xs font-bold text-[#B7FF18]">On-Chain Processing</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div key={step.id} className="flex items-start gap-4">
                    <div className="flex flex-col items-center">
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                        step.status === "completed" ? "bg-[#B7FF18]" :
                        step.status === "active" ? "bg-[#14532d] animate-pulse" :
                        "bg-[#1B2A33]"
                      }`}>
                        {step.status === "completed" ? (
                          <Check className="w-4 h-4 text-[#0A0A10]" />
                        ) : step.status === "active" ? (
                          <div className="w-3 h-3 rounded-full bg-[#B7FF18] animate-pulse" />
                        ) : (
                      ...
                      {index < mintSteps.length - 1 && (
                        <div className={`w-0.5 h-8 ${
                          step.status === "completed" ? "bg-[#B7FF18]/30" : "bg-[#1B2A33]/50"
                        }`} />
                      )}
                    </div>
                    <div className="flex-1 pt-0.5">
                      <p className={`text-sm font-bold ${
                        step.status === "active" ? "text-[#B7FF18]" : "text-[#F5F7F2]"
                      }`}>
                        {step.title}
                      </p>
              ...
              <div className="relative w-[300px] md:w-[400px] h-[300px] md:h-[400px]">
                {(() => {
                  ...
                  return isLeg
                    ...
                    : <div className="absolute inset-0 blur-[40px] bg-[#B7FF18]/20 rounded-full scale-100" />;
                })()}
                ...
                className={`relative w-full h-full rounded-[40px] overflow-hidden bg-white/[0.01] cursor-pointer transition-colors ${
                  (() => {
                    ...
                    return isLeg
                      ...
                      : "border-2 border-[#B7FF18]/30 shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.2)] hover:border-[#B7FF18]/60";
                  })()
                }`}
              >
                    ...
                    {(() => {
                      ...
                      return (
                        <div className={`backdrop-blur-sm border rounded px-2 py-1 ${
                          isLeg ? "bg-[#fbbf24]/20 border-[#fbbf24]/40" : "bg-[#B7FF18]/20 border-[#B7FF18]/30"
                        }`}>
                          <span className={`text-[10px] font-bold uppercase tracking-[0.5px] ${
                            isLeg ? "text-[#fbbf24]" : "text-[#B7FF18]"
                          }`}>
                            {rarityLabel}
                          </span>
                        </div>
                ...
                <button
                  onClick={() => setShowSingleNftDetail(true)}
                  className="absolute -bottom-4 right-6 w-14 h-14 rounded-full bg-[#B7FF18] border-4 border-[#0A0A10] flex items-center justify-center shadow-[0_4px_6px_-4px_rgba(183, 255, 26,0.4),0_10px_15px_-3px_rgba(183, 255, 26,0.4)] hover:bg-[#A2F000] transition-colors cursor-pointer"
                >
                  <Eye className="h-7 w-7 text-[#0A0A10]" />
                </button>
              </div>
            </div>
            ...
            <div className="md:flex-1 flex flex-col items-center md:items-start gap-6 max-w-[382px] md:max-w-none w-full">
              <div className="flex flex-col items-center md:items-start gap-3 mt-2">
                ...
                <div className="flex items-center gap-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#B7FF18]" />
              ...
              <div className="flex flex-col items-center md:items-start gap-1 text-center md:text-left">
                <span className="text-sm font-bold text-[#B7FF18] uppercase tracking-[1.4px]">
                  Successfully Minted
                </span>
              ...
              <div className="flex flex-col md:flex-row gap-3 w-full max-w-[382px]">
                <Button
                  ...
                  className="w-full md:flex-1 h-14 rounded-2xl bg-[#B7FF18] hover:bg-[#A2F000] text-[#0A0A10] text-base font-bold shadow-[0_4px_6px_-4px_rgba(183, 255, 26,0.2),0_10px_15px_-3px_rgba(183, 255, 26,0.2)] flex items-center justify-center gap-2"
                >
      ...
      <main className="flex-1 flex items-start justify-center py-6 md:py-12 px-4 md:px-8 overflow-y-auto">
        <div className="w-full max-w-[430px] md:max-w-5xl flex flex-col md:flex-row md:items-start md:gap-12 gap-6">
          ...
          <div className="md:flex-1 md:max-w-[382px]">
            <div className="relative w-full aspect-square rounded-3xl overflow-hidden bg-white/[0.01] shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.05)]">
              <video
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                <div className="flex flex-col gap-2">
                  <div className="bg-[#B7FF18]/20 border border-[#B7FF18]/20 rounded-xl px-2 py-1 w-fit">
                    <span className="text-[10px] font-bold text-[#B7FF18] uppercase tracking-[0.5px]">
                      Live Minting
                    </span>
                  </div>
          ...
          <div className="md:flex-1 flex flex-col gap-6 max-w-[382px] w-full mx-auto md:mx-0">
            ...
            {useServerSigning && !needsWalletRegeneration && (
              <div className="bg-[#14532d]/20 border border-[#B7FF18]/20 rounded-3xl p-4 flex items-center gap-3">
                <Shield className="h-5 w-5 text-[#B7FF18] shrink-0" />
                <p className="text-xs text-[#B8C0AE]">
              ...
              <div className="flex items-center justify-between p-5 bg-[#14532d]/5 border-b border-[#1B2A33]/50">
                ...
                <div className="flex items-center gap-1.5">
                  {isCheckingAllowance ? (
                    ...
                    <>
                      {allowanceApproved ? (
                        <Check className="h-3 w-3 text-[#B7FF18]" />
                      ) : (
                        <AlertTriangle className="h-3 w-3 text-[#ef4444]" />
                      )}
                      <span className={`text-[10px] font-bold uppercase ${allowanceApproved ? 'text-[#B7FF18]' : 'text-[#ef4444]'}`}>
              ...
              <div className="p-5 flex flex-col gap-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 bg-[#1B2A33] rounded-2xl p-1">
                    ...
                    <button
                      ...
                      className="w-10 h-10 rounded-2xl bg-[#B7FF18] hover:bg-[#A2F000] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
                    >
                      <Plus className="h-5 w-5 text-[#0A0A10]" />
                    </button>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-[#B7FF18]">
                      Free
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[#1B2A33]/30">
                  ...
                  <div className="flex flex-col items-end">
                    <span className="text-xl font-bold text-[#B7FF18]">
              ...
              <button
                  ...
                  className={`w-full h-[68px] rounded-2xl text-xl font-bold flex items-center justify-center gap-2.5 transition-all ${
                    canMint && mintState !== "processing"
                      ? "bg-[#B7FF18] text-[#0A0A10] hover:bg-[#A2F000]"
