...
const slides = [
  ...
  },
  {
    ...
    icon: (
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M80 48V88H16V48" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.3"/>
        <path d="M88 28H8V48H88V28Z" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M48 88V28" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M48 28H32C29.8783 28 27.8434 27.1571 26.3431 25.6569C24.8429 24.1566 24 22.1217 24 20C24 17.8783 24.8429 15.8434 26.3431 14.3431C27.8434 12.8429 29.8783 12 32 12C44 12 48 28 48 28Z" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M48 28H64C66.1217 28 68.1566 27.1571 69.6569 25.6569C71.1571 24.1566 72 22.1217 72 20C72 17.8783 71.1571 15.8434 69.6569 14.3431C68.1566 12.8429 66.1217 12 64 12C52 12 48 28 48 28Z" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M36 60L60 36" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round"/>
        <path d="M84.82 45.64L51.32 12.14C50.42 11.24 49.22 10.74 47.92 10.74H20C16.7 10.74 14 13.44 14 16.74V44.46C14 45.76 14.5 47.04 15.4 47.92L48.88 81.42C50.76 83.3 53.78 83.3 55.68 81.42L84.82 52.28C86.72 50.38 86.72 47.52 84.82 45.64Z" stroke="#B7FF18" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.3"/>
        <circle cx="28" cy="28" r="6" fill="#B7FF18"/>
      </svg>
    ),
  },
];
...
export default function ProOnboardingScreen({ onComplete, lootboxReward }: ProOnboardingScreenProps) {
  ...
  if (showSuccess) {
    ...
    return (
      <div className="flex flex-col w-full h-full min-h-[500px] md:min-h-[600px] bg-[#0A0A10] relative overflow-hidden">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[344px] h-[746px] rounded-full bg-[#B7FF1833] blur-[60px]" />
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-8 px-6 relative z-10">
          ...
          >
            <div className="bg-[#B7FF181a] border border-[#B7FF184d] rounded-full px-4 py-1.5">
              <span className="text-[10px] font-black text-[#B7FF18] uppercase tracking-[2px]">
                Subscription Active
              </span>
            </div>
          ...
          {lootboxReward ? (
            ...
            >
              ...
              <div className={`relative p-1 rounded-2xl ${rarityStyle.bg} border-2 ${rarityStyle.border}`}>
                <div className="w-28 h-28 rounded-xl overflow-hidden flex items-center justify-center bg-[#0A0A10]">
            ...
            >
              <div className="absolute inset-0 rounded-full bg-[#B7FF184d] blur-[30px]" />
        ...
        <div className="px-8 pb-8 md:pb-10 relative z-10">
          <motion.button
            ...
            onClick={onComplete}
            className="w-full max-w-[367px] mx-auto block h-[60px] bg-[#B7FF18] hover:bg-[#A2F000] text-black text-lg font-normal rounded-[28px] transition-colors"
            style={{ boxShadow: "0 10px 20px -5px #B7FF184d" }}
          >
            Continue
          </motion.button>
        </div>
  ...
  return (
    <div className="flex flex-col w-full h-full min-h-[500px] md:min-h-[600px] bg-[#0A0A10] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-12 md:gap-16 px-6">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="relative w-48 h-48 flex items-center justify-center"
          >
            <div className="absolute w-72 h-72 rounded-full bg-[#B7FF1833] blur-[40px] -top-10 -left-10" />
      ...
      <div className="flex flex-col gap-8 px-8 pb-8 md:pb-10">
          ...
          {slides.map((_, i) => (
            <div
              ...
              className={`flex-1 h-2 rounded-full transition-colors duration-300 ${
                i <= currentSlide ? 'bg-[#B7FF18]' : 'bg-[#1B2A33]'
              }`}
            />
          ))}
        </div>
        ...
        <button
          onClick={handleNext}
          className="w-full max-w-[366px] mx-auto flex items-center justify-center gap-2 h-[60px] bg-[#B7FF18] hover:bg-[#A2F000] text-[#0A0A10] text-lg font-bold rounded-2xl transition-colors"
          style={{ boxShadow: "0 0 25px -5px #B7FF1866" }}
        >
          <span>Next</span>
