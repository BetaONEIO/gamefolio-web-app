...
import { Crown, Upload, Sparkles, Gift, Tag, Loader2, ArrowRight, ArrowLeft, X, Ban } from "lucide-react";
...
export default function ProUpgradeDialog({ open, onOpenChange }: ProUpgradeDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-[430px] w-full bg-[#020617] border-none text-white p-0 overflow-hidden flex flex-col h-[90vh] max-h-[900px] [&>button]:hidden"
          ...
          {showCheckout ? (
            ...
            >
              ...
              <div
                ...
                className="flex-1 mx-4 mb-4 rounded-xl overflow-hidden bg-white min-h-[400px]"
            ...
            >
              {/* Hero Image Section */}
              <div className="relative w-full h-[420px] flex-shrink-0">
                <div
                  className="absolute inset-0 bg-cover bg-center"
                  style={{ backgroundImage: `url(${proHeroImage})` }}
                />
                <div className="absolute inset-0 bg-gradient-to-b from-[#02061700] via-[#02061733] to-[#020617]" />

                {/* Close Button */}
                <button
                  onClick={() => onOpenChange(false)}
                  className="absolute top-4 right-4 w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center transition-colors hover:bg-black/60 z-10"
                >
                  <X className="w-5 h-5 text-white" />
                </button>
              </div>

              {/* Pricing Section - overlapping the hero */}
              <div className="relative -mt-40 z-10 px-6 pb-6">
                <div className="bg-gradient-to-b from-[#020617] via-[#020617] to-transparent pt-12 pb-6 flex flex-col items-center gap-4">
                  {/* Plan Info Row */}
              ...
              <div className="px-6 pb-8">
                ...
                {/* Subtitle */}
                <p className="text-[#94a3b8] text-base text-center leading-relaxed mb-8 max-w-[325px] mx-auto">
                  ...
                  {premiumBenefits.map((benefit, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center min-h-[48px]">
                        <span className="text-[#f8fafc] text-lg leading-7">
                          {benefit.title}
                        </span>
