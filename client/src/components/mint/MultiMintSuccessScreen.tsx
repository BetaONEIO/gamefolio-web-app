  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#020617] flex flex-col overflow-hidden font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-md bg-[#020617cc] border-b border-[#1e293b80] flex-shrink-0">
        <div className="flex items-center justify-between w-full max-w-[430px] mx-auto px-6 pt-12 pb-[17px]">
          <button
            onClick={onBack}
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-[#1e293b80] flex items-center justify-center"
          >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="w-full max-w-[430px] mx-auto flex flex-col">
          ...
          <div className="relative w-full" style={{ height: "450px" }}>
            ...
            <div
              ref={carouselRef}
              className="flex gap-4 overflow-x-auto snap-x snap-mandatory px-[75px] py-4 scrollbar-hide"
            ...
            {activeIndex > 0 && (
              <button
                onClick={handlePrev}
                className="absolute left-3 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#1e293bcc] border border-[#1e293b80] backdrop-blur-md flex items-center justify-center shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1),0_10px_15px_-3px_rgba(0,0,0,0.1)]"
              >
                <ArrowLeft className="h-6 w-6 text-[#f8fafc]" />
              </button>
            )}
            {activeIndex < totalSlides - 1 && (
              <button
                onClick={handleNext}
                className="absolute right-3 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#1e293bcc] border border-[#1e293b80] backdrop-blur-md flex items-center justify-center shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1),0_10px_15px_-3px_rgba(0,0,0,0.1)]"
              >
          ...
          {/* Info Section */}
          <div className="flex flex-col items-center gap-4 px-[124px] py-8">
            {/* Transaction Confirmed pill */}
            ...
            {/* NFTs Minted title */}
            <span className="text-[30px] font-bold text-[#f8fafc] text-center leading-9">
          ...
          {/* Collection Value + Buttons Section */}
          <div className="flex flex-col gap-3 px-6 pb-4">
            ...
            <div className="w-full h-[74px] rounded-2xl bg-[#0f172a80] border border-[#1e293b80] flex items-center justify-between px-4">
              ...
              <button onClick={onViewCollection} className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-full h-14 rounded-2xl bg-[#4ade80] flex items-center justify-center gap-[6.5px] shadow-[0_4px_6px_-4px_rgba(74,222,128,0.2),0_10px_15px_-3px_rgba(74,222,128,0.2)]"
            >
            ...
            {/* Mint More NFTs button */}
            <button
              onClick={onBack}
              className="w-full h-[58px] rounded-2xl bg-[#1e293b] border border-[#1e293b80] flex items-center justify-center gap-[6.5px]"
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
