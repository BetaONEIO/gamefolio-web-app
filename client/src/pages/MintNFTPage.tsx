              ...
              <div className="relative w-[300px] md:w-[400px] h-[300px] md:h-[400px]">
                {(() => {
                  ...
                  return isLeg
                    ...
                    : <div className="absolute inset-0 blur-[40px] bg-[#B7FF1A]/20 rounded-full scale-100" />;
                })()}
                ...
                className={`relative w-full h-full rounded-[40px] overflow-hidden bg-white/[0.01] cursor-pointer transition-colors ${
                  (() => {
                    ...
                    return isLeg
                      ...
                      : "border-2 border-[#B7FF1A]/30 shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.2)] hover:border-[#B7FF1A]/60";
                  })()
                }`}
              >
                    ...
                    {(() => {
                      ...
                      return (
                        <div className={`backdrop-blur-sm border rounded px-2 py-1 ${
                          isLeg ? "bg-[#fbbf24]/20 border-[#fbbf24]/40" : "bg-[#B7FF1A]/20 border-[#B7FF1A]/30"
                        }`}>
                          <span className={`text-[10px] font-bold uppercase tracking-[0.5px] ${
                            isLeg ? "text-[#fbbf24]" : "text-[#B7FF1A]"
                          }`}>
                            {rarityLabel}
                          </span>
                        </div>
            ...
            <div className="md:flex-1 flex flex-col items-center md:items-start gap-6 max-w-[382px] md:max-w-none w-full">
              ...
              <div className="flex flex-col md:flex-row gap-3 w-full max-w-[382px]">
                <Button
                  ...
                  className="w-full md:flex-1 h-14 rounded-2xl bg-[#B7FF1A] hover:bg-[#A2F000] text-[#071013] text-base font-bold shadow-[0_4px_6px_-4px_rgba(183, 255, 26,0.2),0_10px_15px_-3px_rgba(183, 255, 26,0.2)] flex items-center justify-center gap-2"
                >
            ...
            <div className="relative w-full aspect-square rounded-3xl overflow-hidden bg-white/[0.01] shadow-[0_25px_50px_-12px_rgba(183, 255, 26,0.05)]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                <div className="flex flex-col gap-2">
                  <div className="bg-[#B7FF1A]/20 border border-[#B7FF1A]/20 rounded-xl px-2 py-1 w-fit">
                    <span className="text-[10px] font-bold text-[#B7FF1A] uppercase tracking-[0.5px]">
                      Live Minting
                    </span>
                  </div>
              ...
              <div className="flex items-center justify-between p-5 bg-[#14532d]/5 border-b border-[#1e293b]/50">
                ...
                <div className="flex items-center gap-1.5">
                  {isCheckingAllowance ? (
                    ...
                    <>
                      {allowanceApproved ? (
                        <Check className="h-3 w-3 text-[#B7FF1A]" />
                      ) : (
                        <AlertTriangle className="h-3 w-3 text-[#ef4444]" />
                      )}
                      <span className={`text-[10px] font-bold uppercase ${allowanceApproved ? 'text-[#B7FF1A]' : 'text-[#ef4444]'}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 bg-[#1e293b] rounded-2xl p-1">
                    ...
                    <button
                      ...
                      className="w-10 h-10 rounded-2xl bg-[#B7FF1A] hover:bg-[#A2F000] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
                    >
                      <Plus className="h-5 w-5 text-[#071013]" />
                    </button>
                  </div>
                </div>
