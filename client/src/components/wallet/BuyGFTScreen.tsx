    ...
    >
          ...
          {presetAmounts.map((amount) => {
            ...
            return (
              <button
                ...
                style={{ 
                  background: isSelected ? '#B7FF18' : '#1B2A33',
                  border: `1px solid ${isSelected ? '#B7FF18' : '#1B2A33'}`,
                  color: isSelected ? '#0A0A10' : '#F5F7F2',
                  boxShadow: isSelected ? '0 0 20px -5px #B7FF18' : 'none'
                }}
              >
                {formatPreset(amount)}
              </button>
      ...
      >
        <div className="max-w-[600px] mx-auto w-full flex flex-col gap-4">
          ...
          >
            <span style={{ color: '#0A0A10' }}>Continue to Payment</span>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
