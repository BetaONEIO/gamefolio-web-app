    ...
    >
      ...
      <div className="px-5 pb-5 pt-4 space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          <RewardCol icon={<img src="/icons/demo-key-icon.png" alt="Demo" className="w-[30px] h-[30px] object-contain" style={{ filter: demoLeft > 0 ? "drop-shadow(0 0 6px rgba(184,255,27,0.6))" : "grayscale(0.6) brightness(0.7)" }} />} label="Demo Key"  value={demoLeft  > 0 ? `${demoLeft}`  : "—"} active={demoLeft  > 0} />
          <RewardCol icon={<img src="/icons/full-game-icon.png" alt="Full" className="w-[30px] h-[30px] object-contain" style={{ filter: fullLeft > 0 ? "drop-shadow(0 0 6px rgba(184,255,27,0.5))" : "grayscale(0.6) brightness(0.7)" }} />} label="Full Game" value={fullLeft  > 0 ? `${fullLeft}`  : "—"} active={fullLeft  > 0} />
          <RewardCol icon={<Zap size={30} color={totalXP > 0 ? NEON : "rgba(255,255,255,0.35)"} />} label="Total XP"  value={totalXP > 0 ? `${totalXP.toLocaleString()}` : "—"} active={totalXP > 0} />
          <RewardCol icon={<img src="/icons/token-icon.png" alt="Token" className="w-[30px] h-[30px] object-contain" style={{ filter: "grayscale(0.6) brightness(0.7)" }} />} label="GFT / SKL" value="—" active={false} />
        </div>
