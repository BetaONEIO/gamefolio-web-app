...
const RARITY_MAP: Record<string, { label: string; color: string; bg: string; percent: string }> = {
  ...
  uncommon: { label: "Uncommon", color: "text-[#B7FF18]", bg: "bg-[#B7FF18]/10 border-[#B7FF18]/20", percent: "25%" },
      ...
      >
        <div className="relative w-full md:w-[340px] flex-shrink-0">
          {isLoading ? (
            <div className="w-full aspect-square bg-[#1B2A33] flex items-center justify-center">
              <div className="w-10 h-10 rounded-full border-2 border-[#B7FF18]/30 border-t-[#B7FF18] animate-spin" />
            </div>
          ) : nftImage ? (
            <img
              src={nftImage}
          ...
          <button
            ...
            className="absolute top-3 right-3 z-20 w-7 h-7 rounded-full bg-black/50 backdrop-blur-lg flex items-center justify-center hover:bg-black/70 transition-colors md:hidden"
          >
        ...
        <div className="flex-1 flex flex-col p-4 pb-8 overflow-y-auto scrollbar-hide font-['Plus_Jakarta_Sans',sans-serif] relative" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <button
            ...
            className="absolute top-3 right-3 z-20 w-7 h-7 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors hidden md:flex"
          >
          ...
          <div className="flex flex-col gap-1 mb-3">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <div className="w-4 h-4 rounded-full bg-[#B7FF18]/20 flex items-center justify-center overflow-hidden">
                <div className="w-full h-full opacity-60 bg-gradient-to-br from-[#B7FF18] to-[#A2F000]" />
              </div>
          ...
          <div className="w-full rounded-xl bg-[#1B2A33]/50 border border-[#1B2A33] p-3 mb-3">
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-sm font-bold text-[#B7FF18]">Confirmed</span>
