...
export function CreatorDashboard({ bountyId, open, onClose }: CreatorDashboardProps) {
  ...
  if (isLoading) {
    return (
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="max-w-lg border-0" style={{ background: "#0A0A10", border: "1px solid rgba(255,255,255,0.1)" }}>
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg border-0 overflow-hidden" style={{ background: "#0A0A10", border: "1px solid rgba(255,255,255,0.1)" }}>
        <DialogHeader>
