...
const ClipFeedCard: React.FC<ClipFeedCardProps> = ({ clip, clips, isDesktop }) => {
  const { user } = useAuth();
    ...
    >
      ...
      {commentsOverlay && (
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-3" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 120px)' }}>
            <CommentSection
              clipId={clip.id}
