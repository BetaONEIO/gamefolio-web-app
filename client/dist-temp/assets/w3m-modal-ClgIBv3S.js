import{U as ve,N as fe,L as ge,G as be,M as g,S as re,R as l,B as v,J as P,D as f,X as a,a as K,y as ce,u as le,C as m,d as Y,c as ye,j as S,l as ie,O as E,f as q,A as oe,m as T,b as H,o as xe,F as Ce,k as ke,h as Se}from"./core-BMGMMe97.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-DM-Cw6cZ.js";import"./index-DYPkZNjU.js";import"./index.es-BIvAXaIk.js";import"./events-DQ172AOg.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},N=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
