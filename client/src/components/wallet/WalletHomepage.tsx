...
export default function WalletHomepage({
  ...
  return (
    <div className="w-full min-h-screen pb-[calc(var(--mobile-nav-height,3.5rem)+1.5rem+env(safe-area-inset-bottom,0px))] md:pb-8 font-['Plus_Jakarta_Sans']" style={{ background: '#0A0A10' }}>
                ...
                {ownedNFTs.length > 0 && (
                  <Link href="/collection">
                    <span 
                      ...
                      style={{ color: '#B7FF18', fontSize: '14px', fontWeight: 600 }}
                    >
                      View All
                    </span>
                  </Link>
              ...
              >
                {ownedNFTs.length > 0 ? (
                  <div className="flex items-center justify-center p-4 h-full">
                    {ownedNFTs.length === 1 ? (
                      <Link href="/collection">
                        <div className="relative w-full max-w-[200px] aspect-square rounded-xl overflow-hidden hover:ring-2 hover:ring-[#B7FF18] transition-all group cursor-pointer">
                          {ownedNFTs[0].image ? (
                            <img
                            ...
                            <div className="w-full h-full bg-gradient-to-br from-[#B7FF18] to-[#6FA800] flex items-center justify-center">
                            ...
                            <div className="absolute bottom-2 left-2 px-2 py-0.5 rounded text-[10px] font-bold uppercase"
                              style={{
                                background: ownedNFTs[0].rarity === 'Legendary' ? '#EAB308' : 
                                           ...
                                           ownedNFTs[0].rarity === 'Rare' ? '#3b82f6' : '#B7FF18',
                                color: '#fff'
                              }}
                            >
                              {ownedNFTs[0].rarity}
                      ...
                      <Link href="/collection">
                        <div className="relative w-full max-w-[200px] aspect-square rounded-xl overflow-hidden cursor-pointer hover:ring-2 hover:ring-[#B7FF18] transition-all group">
                          {ownedNFTs[0].image ? (
                            <img
                              src={ownedNFTs[0].image}
                              alt={ownedNFTs[0].name}
                  ...
                  <div className="flex flex-col items-center justify-center py-8 h-full">
                    ...
                    <Link href="/store">
                      <span className="hover:underline" style={{ color: '#B7FF18', fontSize: '12px' }}>Browse the store</span>
                    </Link>
                  </div>
                )}
              </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-6 order-1 lg:order-2">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <span style={{ color: '#0A0A10', fontSize: '16px' }}>Buy GFT</span>
              </button>
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <span style={{ color: '#B7FF18', fontSize: '14px', fontWeight: 600 }}>{offChainBalance.toLocaleString(undefined, { maximumFractionDigits: 2 })} GFT</span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="flex items-start justify-between">
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M1.9705 2.96449C1.75 3.27832 1.75 4.21166 1.75 6.07657V6.99474C1.75 10.2836 4.22275 11.8802 5.77442 12.5574C6.195 12.7412 6.40558 12.8333 7 12.8333C7.595 12.8333 7.805 12.7412 8.22558 12.5574C9.77725 11.8796 12.25 10.2842 12.25 6.99474V6.07657C12.25 4.21107 12.25 3.27832 12.0295 2.96449C11.8096 2.65124 10.9328 2.35082 9.17875 1.75057L8.8445 1.63624C7.93042 1.32299 7.47367 1.16666 7 1.16666C6.52633 1.16666 6.06958 1.32299 5.1555 1.63624L4.82125 1.74999C3.06717 2.35082 2.19042 2.65124 1.9705 2.96449ZM8.785 6.12499C8.8891 6.00828 8.92303 5.84491 8.874 5.6964C8.82498 5.5479 8.70046 5.43682 8.54734 5.40503C8.39422 5.37323 8.23576 5.42553 8.13167 5.54224L6.37525 7.51041L5.86775 6.94224C5.70629 6.76382 5.43104 6.74929 5.25169 6.90971C5.07234 7.07014 5.0562 7.34529 5.21558 7.52557L6.04858 8.45891C6.13159 8.55189 6.25032 8.60506 6.37496 8.60506C6.4996 8.60506 6.61833 8.55189 6.70133 8.45891L8.785 6.12499Z" fill="#B7FF18" />
                  </svg>
                  <span 
                    className="text-xs font-bold uppercase"
                    style={{ color: '#B7FF18', fontSize: '10px' }}
                  >
                    SKALE Network
                  </span>
                </div>
                      ...
                      >
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            <span
                              ...
                              style={{
                                ...
                                color: w.isPrimary ? '#B7FF18' : '#B8C0AE',
                                border: w.isPrimary
                        ...
                        <div className="text-right flex-shrink-0">
                          <span
                            className="font-bold"
                            style={{
                              color: retiredWithBalance ? '#f59e0b' : '#B7FF18',
                              fontSize: '14px',
                            }}
