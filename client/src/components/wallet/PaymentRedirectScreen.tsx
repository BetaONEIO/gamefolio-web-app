    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8 max-w-[600px] mx-auto w-full">
        ...
        <div className="relative w-24 h-24 mb-8">
          ...
          >
            <circle cx="48" cy="48" r="44" stroke="rgba(183, 255, 26, 0.2)" strokeWidth="4" fill="none" />
            <path
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M29.2968 7.38666L25.9635 5.63666C23.0368 4.10166 21.5735 3.33333 20.0002 3.33333C18.4268 3.33333 16.9635 4.1 14.0368 5.63666L10.7035 7.38666C7.7485 8.93666 6.01016 9.85 4.9335 11.07L20.0002 18.6033L35.0668 11.07C33.9902 9.85 32.2535 8.93666 29.2968 7.38666Z" fill="#B7FF1A" />
              <path fillRule="evenodd" clipRule="evenodd" d="M36.2468 13.2733L21.2502 20.7733V36.5067C22.4468 36.2083 23.8085 35.495 25.9635 34.3633L29.2968 32.6133C32.8818 30.7317 34.6752 29.7917 35.6718 28.1C36.6668 26.41 36.6668 24.305 36.6668 20.1V19.905C36.6668 16.75 36.6668 14.7767 36.2468 13.2733Z" fill="#B7FF1A" />
              <path fillRule="evenodd" clipRule="evenodd" d="M18.7502 36.5067V20.7733L3.7535 13.2733C3.3335 14.7767 3.3335 16.75 3.3335 19.9017V20.0967C3.3335 24.305 3.3335 26.41 4.3285 28.1C5.32516 29.7917 7.1185 30.7333 10.7035 32.615L14.0368 34.3633C16.1918 35.495 17.5535 36.2083 18.7502 36.5067Z" fill="#B7FF1A" />
            </svg>
          </div>
        </div>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          {/* Lock Icon */}
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M16.25 6.25H13.75V4.375C13.75 2.30393 12.0711 0.625 10 0.625C7.92893 0.625 6.25 2.30393 6.25 4.375V6.25H3.75C3.05964 6.25 2.5 6.80964 2.5 7.5V16.25C2.5 16.9404 3.05964 17.5 3.75 17.5H16.25C16.9404 17.5 17.5 16.9404 17.5 16.25V7.5C17.5 6.80964 16.9404 6.25 16.25 6.25Z" fill="#F5F7F2" />
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M12.5 6.25H7.5V4.375C7.5 2.99429 8.61929 1.875 10 1.875C11.3807 1.875 12.5 2.99429 12.5 4.375V6.25Z" fill="#0B1218" />
          </svg>

          {/* Shield Icon */}
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M16.25 3.125H3.75C3.05964 3.125 2.5 3.68464 2.5 4.375V8.75C2.5 12.8687 4.49375 15.3648 6.16641 16.7336C7.96797 18.207 9.76016 18.707 9.83828 18.7281C9.9457 18.7573 10.059 18.7573 10.1664 18.7281C10.2445 18.707 12.0344 18.207 13.8383 16.7336C15.5063 15.3648 17.5 12.8687 17.5 8.75V4.375C17.5 3.68464 16.9404 3.125 16.25 3.125Z" fill="#F5F7F2" />
            <path d="M7.5 10L9.16667 11.6667L12.5 8.33333" stroke="#0B1218" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>

          {/* Checkmark Circle Icon */}
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="10" cy="10" r="8.75" fill="#F5F7F2" />
            <path d="M6.5 10L9 12.5L13.5 7.5" stroke="#0B1218" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        ...
        <span 
          ...
          style={{ color: '#B8C0AE', letterSpacing: '2px' }}
        >
