...
export default function PortfolioChart({ data }: PortfolioChartProps) {
  ...
  return (
    <div className="relative">
          ...
          return (
            <div key={item.day} className="flex-1 flex flex-col items-center gap-2">
              <motion.div
                ...
                className="w-full bg-gradient-to-t from-[#B7FF18] to-[#6FA800] rounded-t-lg relative group cursor-pointer"
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#B7FF18]/10 to-transparent pointer-events-none rounded-lg" />
    </div>
  );
}
