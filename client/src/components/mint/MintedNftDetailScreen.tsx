        ...
        <div className="w-full max-w-[430px] md:max-w-5xl mx-auto flex flex-col md:flex-row md:gap-10 md:px-4">
          ...
          <div className="md:flex-1 flex flex-col gap-6 px-6 py-6">
            ...
            <div className="flex flex-col md:flex-row gap-3">
              <button
                onClick={onClose}
                className="w-full md:flex-1 h-[60px] rounded-2xl bg-[#4ade80] flex items-center justify-center gap-2 shadow-[0_4px_6px_-4px_rgba(74,222,128,0.2),0_10px_15px_-3px_rgba(74,222,128,0.2)] hover:bg-[#22c55e] transition-colors"
              >
              ...
              <button
                ...
                disabled={sold}
                className={`w-full md:flex-1 h-[60px] rounded-2xl flex items-center justify-center gap-2 transition-colors ${sold ? 'bg-[#1e293b60] opacity-50 cursor-not-allowed' : 'bg-[#1e293b] hover:bg-[#ef4444] group'}`}
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
